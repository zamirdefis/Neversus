...
VisualsTabCategoryWorld:AddSlider("Exposure Compensation", {0, 56, 0, 0.01, ""}, "VisualsTabCategoryWorldExposureCompensation", function(val)
...
VisualsTabCategoryWorld:AddSlider("Shadow Softness", {0, 1, 0.2, 0.01, ""}, "VisualsTabCategoryWorldShadowSoftness", function(val)
	game.Lighting.ShadowSoftness = val
end)
