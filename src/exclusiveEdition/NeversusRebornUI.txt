...
local HackWSFolder = Instance.new("Folder", workspace)
HackWSFolder.Name = "Neversus"
local HWSVisualsFolder = Instance.new("Folder", HackWSFolder)
HWSVisualsFolder.Name = "Visuals"
local HWSVFHL = Instance.new("Folder", HWSVisualsFolder)
HWSVFHL.Name = "WorkspaceHighlight"
local HWSVFBT = Instance.new("Folder", HWSVisualsFolder)
HWSVFBT.Name = "BulletTrace"
local HWSVFHB = Instance.new("Folder", HWSVisualsFolder)
HWSVFHB.Name = "HitBullet"
local HackSrcGUI = Instance.new("ScreenGui", plr.PlayerGui)
HackSrcGUI.Name = "Neversus"
...
local whl = Instance.new("Highlight", HWSVFHL)
whl.Name = "WorkspaceHighlight"
whl.Enabled = false
...
local function AddBox(Model, IsPlayer, Thickness, Color, LineJoinMode, Transparency, FillColor, FillTransparency)
	...
	if IsPlayer then
		--connect2 = pl:GetPropertyChangedSignal("Team"):Connect(function()
		--end)
		connect5 = Model:GetPropertyChangedSignal("Parent"):Connect(function()
			ld()
		end)
...
OnBoxAdd = function(Box)
	if library.pointers.VisualsTabCategoryEspNames.value then
		table.insert(TNames, AddTagToBox(Box, "up", Box.Name, library.pointers.VisualsTabCategoryEspNamesC.value, Enum.Font[library.pointers.VisualsTabCategoryEspNamesFont.value], library.pointers.VisualsTabCategoryEspTagsSize.value, library.pointers.VisualsTabCategoryEspNamesTT.value, library.pointers.VisualsTabCategoryEspNamesTST.value, library.pointers.VisualsTabCategoryEspNamesSC.value))
	end
	if library.pointers.VisualsTabCategoryEspDNames and library.pointers.VisualsTabCategoryEspDNames.value then
		if not library.pointers.VisualsTabCategoryEspDNDNDIM.value or Box.Name ~= plrs[Box.Name].DisplayName then 
			table.insert(TDNames, AddTagToBox(Box, "up", plrs[Box.Name].DisplayName, library.pointers.VisualsTabCategoryEspDNamesC.value, Enum.Font[library.pointers.VisualsTabCategoryEspDNamesFont.value], library.pointers.VisualsTabCategoryEspTagsSize.value, library.pointers.VisualsTabCategoryEspDNamesTT.value, library.pointers.VisualsTabCategoryEspDNamesTST.value, library.pointers.VisualsTabCategoryEspDNamesSC.value))
		end
	end
	if library.pointers.VisualsTabCategoryEspAAge and library.pointers.VisualsTabCategoryEspAAge.value then
		table.insert(AAge, AddTagToBox(Box, "up", plrs[Box.Name].AccountAge .. AAgePfx, library.pointers.VisualsTabCategoryEspAAgeC.value, Enum.Font[library.pointers.VisualsTabCategoryEspAAgeFont.value], library.pointers.VisualsTabCategoryEspTagsSize.value, library.pointers.VisualsTabCategoryEspAAgeTT.value, library.pointers.VisualsTabCategoryEspAAgeTST.value, library.pointers.VisualsTabCategoryEspAAgeSC.value))
	end
	if library.pointers.VisualsTabCategoryEspUserId and library.pointers.VisualsTabCategoryEspUserId.value then
		table.insert(UserId, AddTagToBox(Box, "up", plrs[Box.Name].UserId, library.pointers.VisualsTabCategoryEspUserIdC.value, Enum.Font[library.pointers.VisualsTabCategoryEspUserIdFont.value], library.pointers.VisualsTabCategoryEspTagsSize.value, library.pointers.VisualsTabCategoryEspUserIdTT.value, library.pointers.VisualsTabCategoryEspUserIdTST.value, library.pointers.VisualsTabCategoryEspUserIdSC.value))
	end
	if library.pointers.VisualsTabCategoryEspDis and library.pointers.VisualsTabCategoryEspDis.value then
		...
		if Character:WaitForChild("HumanoidRootPart") then
			...
			local Tag = AddTagToBox(Box, "up", math.floor((HRP.Position - CHRP.Position).magnitude) .. DisPfx, library.pointers.VisualsTabCategoryEspDisC.value, Enum.Font[library.pointers.VisualsTabCategoryEspDisFont.value], library.pointers.VisualsTabCategoryEspTagsSize.value, library.pointers.VisualsTabCategoryEspDisTT.value, library.pointers.VisualsTabCategoryEspDisTST.value, library.pointers.VisualsTabCategoryEspDisSC.value)
	...
	if library.pointers.VisualsTabCategoryEspHealth and library.pointers.VisualsTabCategoryEspHealth.value then
		if plrs[Box.Name] then
			...
			local Tag = AddTagToBox(Box, "right", math.ceil(Hum.Health) .. (library.pointers.VisualsTabCategoryEspHealthMinify.value and "" or "/" .. Hum.MaxHealth), library.pointers.VisualsTabCategoryEspArmorC.value, Enum.Font[library.pointers.VisualsTabCategoryEspHealthFont.value], library.pointers.VisualsTabCategoryEspTagsSize.value, library.pointers.VisualsTabCategoryEspHealthTT.value, library.pointers.VisualsTabCategoryEspHealthTST.value, library.pointers.VisualsTabCategoryEspHealthSC.value)
	...
	if library.pointers.VisualsTabCategoryEspArmor and library.pointers.VisualsTabCategoryEspArmor.value then
		if plrs[Box.Name] then
			...
			local function ShowTag()
				local Tag = AddTagToBox(Box, "right", "HK", library.pointers.VisualsTabCategoryEspArmorC.value, Enum.Font[library.pointers.VisualsTabCategoryEspArmorFont.value], library.pointers.VisualsTabCategoryEspTagsSize.value, library.pointers.VisualsTabCategoryEspArmorTT.value, library.pointers.VisualsTabCategoryEspArmorTST.value, library.pointers.VisualsTabCategoryEspArmorSC.value)
...
OnTagsRemove = function(Reset)
	...
	if Reset then
		...
		if library.pointers.VisualsTabCategoryEspUserId and library.pointers.VisualsTabCategoryEspUserId.value then
			for _, v in ipairs(BoxesStoragePath:GetChildren()) do
				table.insert(UserId, AddTagToBox(v, "up", plrs[v.Name].UserId, library.pointers.VisualsTabCategoryEspUserIdC.value, Enum.Font[library.pointers.VisualsTabCategoryEspUserIdFont.value], library.pointers.VisualsTabCategoryEspTagsSize.value, library.pointers.VisualsTabCategoryEspUserIdTT.value, library.pointers.VisualsTabCategoryEspUserIdTST.value, library.pointers.VisualsTabCategoryEspUserIdSC.value))
			end
		end
		if library.pointers.VisualsTabCategoryEspAAge and library.pointers.VisualsTabCategoryEspAAge.value then
			for _, v in ipairs(BoxesStoragePath:GetChildren()) do
			...
			for _, v in ipairs(BoxesStoragePath:GetChildren()) do
				if plrs[v.Name] then
					...
					if Character:WaitForChild("HumanoidRootPart") then
						local HRP = Character.HumanoidRootPart
						local CHRP = plr.Character.HumanoidRootPart
						local Tag = AddTagToBox(v, "up", math.floor((HRP.Position - CHRP.Position).magnitude) .. DisPfx, library.pointers.VisualsTabCategoryEspDisC.value, Enum.Font[library.pointers.VisualsTabCategoryEspDisFont.value], library.pointers.VisualsTabCategoryEspTagsSize.value, library.pointers.VisualsTabCategoryEspDisTT.value, library.pointers.VisualsTabCategoryEspDisTST.value, library.pointers.VisualsTabCategoryEspDisSC.value)
						table.insert(Dis, Tag)
						local connect1
						local connect2
						connect1 = run.Heartbeat:Connect(function()
		...
		if library.pointers.VisualsTabCategoryEspHealth and library.pointers.VisualsTabCategoryEspHealth.value then
			for _, v in ipairs(BoxesStoragePath:GetChildren()) do
				if plrs[v.Name] then
					...
					local Tag = AddTagToBox(v, "right", math.ceil(Hum.Health) .. (library.pointers.VisualsTabCategoryEspHealthMinify.value and "" or "/" .. Hum.MaxHealth), library.pointers.VisualsTabCategoryEspArmorC.value, Enum.Font[library.pointers.VisualsTabCategoryEspHealthFont.value], library.pointers.VisualsTabCategoryEspTagsSize.value, library.pointers.VisualsTabCategoryEspHealthTT.value, library.pointers.VisualsTabCategoryEspHealthTST.value, library.pointers.VisualsTabCategoryEspHealthSC.value)
					table.insert(THealth, Tag)
					local connect1
					local connect3
					connect1 = Hum:GetPropertyChangedSignal("Health"):Connect(function()
		...
		if library.pointers.VisualsTabCategoryEspArmor and library.pointers.VisualsTabCategoryEspArmor.value then
			for _, v in ipairs(BoxesStoragePath:GetChildren()) do
				if plrs[v.Name] then
					local Hum = plrs[v.Name].Character:WaitForChild("Humanoid")
					local function ShowTag()
						local Tag = AddTagToBox(v, "right", "HK", library.pointers.VisualsTabCategoryEspArmorC.value, Enum.Font[library.pointers.VisualsTabCategoryEspArmorFont.value], library.pointers.VisualsTabCategoryEspTagsSize.value, library.pointers.VisualsTabCategoryEspArmorTT.value, library.pointers.VisualsTabCategoryEspArmorTST.value, library.pointers.VisualsTabCategoryEspArmorSC.value)
						table.insert(TArmor, Tag)
						if library.pointers.VisualsTabCategoryEspArmorCCWAIB.value then
							local function ChengeColor()
								if Hum.Health <= MHealth then
...
VisualsTabCategoryEsp:AddSlider("Tags Size", {0, 50, 15, 0.01, ""}, "VisualsTabCategoryEspTagsSize", function()
	RemoveTags(true)
end)
...
local VisualsTabCategoryHit = VisualsTab:AddCategory("Hit", 1)

VisualsTabCategoryHit:AddToggle("Visualize Hit", false, "VisualsTabCategoryHitVH")

VisualsTabCategoryHit:AddColorPicker("Color", Color3.new(1, 0, 0.0313725), "VisualsTabCategoryHitVHColor")

VisualsTabCategoryHit:AddColorPicker("Player Hit Color", Color3.new(0.439216, 1, 0.0627451), "VisualsTabCategoryHitVHPHColor")

VisualsTabCategoryHit:AddDropdown("Shape", {"Block", "Ball"}, "Block", "VisualsTabCategoryHitVHShape")

VisualsTabCategoryHit:AddDropdown("Material", Materials, "SmoothPlastic", "VisualsTabCategoryHitVHMaterial")

VisualsTabCategoryHit:AddSlider("Transparency", {0, 1, 0, 0.01, ""}, "VisualsTabCategoryHitVHTransparency")

VisualsTabCategoryHit:AddSlider("Life Time", {0.01, 5, 2, 0.01, ""}, "VisualsTabCategoryHitVHLifeTime")

VisualsTabCategoryHit:AddSlider("Removal Speed", {0.01, 15, 5, 0.01, ""}, "VisualsTabCategoryHitVHRemovalSpeed")

VisualsTabCategoryHit:AddSlider("Size", {0.01, 5, 0.5, 0.01, ""}, "VisualsTabCategoryHitVHSize")

VisualsTabCategoryHit:AddToggle("Visualize Bullet Trace", false, "VisualsTabCategoryHitVBT")

VisualsTabCategoryHit:AddColorPicker("Color", Color3.new(1, 0, 0.0156863), "VisualsTabCategoryHitBTColor")

VisualsTabCategoryHit:AddColorPicker("Player Hit Color", Color3.new(0.270588, 1, 0.00392157), "VisualsTabCategoryHitBTPHColor")

VisualsTabCategoryHit:AddSlider("Transparency", {0, 1, 0, 0.01, ""}, "VisualsTabCategoryHitBTTransparency")

VisualsTabCategoryHit:AddSlider("Life Time", {0.01, 5, 2, 0.01, ""}, "VisualsTabCategoryHitBTLifeTime")

VisualsTabCategoryHit:AddSlider("Removal Speed", {0.01, 15, 5, 0.01, ""}, "VisualsTabCategoryHitBTRemovalSpeed")

VisualsTabCategoryHit:AddSlider("Width0", {0.01, 50, 4, 0.01, ""}, "VisualsTabCategoryHitBTWidth0")

VisualsTabCategoryHit:AddSlider("Width1", {0.01, 50, 4, 0.01, ""}, "VisualsTabCategoryHitBTWidth1")

VisualsTabCategoryHit:AddSlider("Light Emission", {0, 1, 1, 0.01, ""}, "VisualsTabCategoryHitBTLightEmission")

VisualsTabCategoryHit:AddSlider("Light Influence", {0, 1, 0, 0.01, ""}, "VisualsTabCategoryHitBTLightInfluence")

VisualsTabCategoryHit:AddSlider("Brightness", {0, 10, 1, 0.01, ""}, "VisualsTabCategoryHitBTBrightness")
...
local function CreateBulletTrace(Vec_Start, Vec_End, HitPart)
	...
	Beam.Transparency = NumberSequence.new(library.pointers.VisualsTabCategoryHitBTTransparency.value)
	Beam.LightInfluence = library.pointers.VisualsTabCategoryHitBTLightInfluence.value
	Beam.LightEmission = library.pointers.VisualsTabCategoryHitBTLightEmission.value
	Beam.Brightness = library.pointers.VisualsTabCategoryHitBTBrightness.value
	Beam.Width0 = library.pointers.VisualsTabCategoryHitBTWidth0.value
	Beam.Width1 = library.pointers.VisualsTabCategoryHitBTWidth1.value
	Beam.Texture = "rbxassetid://5210472205"
	Beam.Color = ColorSequence.new(HitPart and (HitPart.Parent:FindFirstChild("Humanoid") or HitPart.Parent.Parent and HitPart.Parent.Parent:FindFirstChild("Humanoid")) and library.pointers.VisualsTabCategoryHitBTPHColor.value or library.pointers.VisualsTabCategoryHitBTColor.value)
	Beam.FaceCamera = true
	Beam.Parent = StartPart
	StartPart.Parent = HWSVFBT
	EndPart.Parent = StartPart
	task.delay(0, function()
		wait(library.pointers.VisualsTabCategoryHitBTLifeTime.value)
		for i = 1, 10 do
			wait(library.pointers.VisualsTabCategoryHitBTRemovalSpeed.value / 8)
...
local function DebugV3(Vector_3)
	...
	DebugPart.Color = Color3.fromRGB(160, 255, 52)
	DebugPart.Size = Vector3.new(1, 1, 1)
	DebugPart.Position = Vector_3
	DebugPart.Name = "DebugPart"
	DebugPart.Parent = plr.Character
end
...
gmt.__namecall = newcclosure(function(self, ...)
	...
	if tostring(self) == "ShootEvent" and tostring(method) == "FireServer" then
		...
		if plr.Character:FindFirstChildOfClass("Tool") and plr.Character:FindFirstChildOfClass("Tool"):FindFirstChild("Muzzle") and plr.Character:FindFirstChild("Head") then
			if library.pointers.VisualsTabCategoryHitVH.value then
				for i in ipairs(Args[1]) do
					local Orig = plr.Character:FindFirstChildOfClass("Tool").Muzzle.Position
					...
					HitPart.Color = Args[1][i]["Hit"] and (Args[1][i]["Hit"].Parent:FindFirstChild("Humanoid") or Args[1][i]["Hit"].Parent.Parent and Args[1][i]["Hit"].Parent.Parent:FindFirstChild("Humanoid")) and library.pointers.VisualsTabCategoryHitVHPHColor.value or library.pointers.VisualsTabCategoryHitVHColor.value
					HitPart.Shape = Enum.PartType[library.pointers.VisualsTabCategoryHitVHShape.value]
					HitPart.Material = Enum.Material[library.pointers.VisualsTabCategoryHitVHMaterial.value]
					HitPart.Size = Vector3.new(library.pointers.VisualsTabCategoryHitVHSize.value, library.pointers.VisualsTabCategoryHitVHSize.value, library.pointers.VisualsTabCategoryHitVHSize.value)
					HitPart.Transparency = library.pointers.VisualsTabCategoryHitVHTransparency.value
					HitPart.CFrame = CFrame.new(Args[1][i]["Cframe"].Position + (Args[1][i]["Cframe"].Position - Orig))
					HitPart.Name = "HitPart"
					HitPart.Parent = HWSVFHB
					task.delay(0, function()
						wait(library.pointers.VisualsTabCategoryHitVHLifeTime.value)
						local Goal = {}
						Goal.Transparency = 1
						local TtweenInfo = TweenInfo.new(library.pointers.VisualsTabCategoryHitVHRemovalSpeed.value)
						local Tween = TweenService:Create(HitPart, TtweenInfo, Goal)
						Tween:Play()
			...
			if library.pointers.VisualsTabCategoryHitVBT.value then
				for i in ipairs(Args[1]) do
					local MuOrig = plr.Character:FindFirstChildOfClass("Tool").Muzzle.Position
					local End = Args[1][i]["Cframe"].Position + (Args[1][i]["Cframe"].Position - MuOrig)
					CreateBulletTrace(plr.Character.Head.Position, End, Args[1][i]["Hit"])
				end
			end
		end
