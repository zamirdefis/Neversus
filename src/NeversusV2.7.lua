...
local function AddTagToBox(Box, Place, Text, Color, font, Size) -- Place: Up, Down, Left, Right
...
OnBoxAdd = function(Box)
	if library.pointers.VisualsTabCategoryEspNames.value then
		table.insert(TNames, AddTagToBox(Box, "up", Box.Name, library.pointers.VisualsTabCategoryEspNamesC.value, library.pointers.VisualsTabCategoryEspNamesFont and Enum.Font[library.pointers.VisualsTabCategoryEspNamesFont.value] or Enum.Font.Code, library.pointers.VisualsTabCategoryEspNamesS.value))
	end
	if library.pointers.VisualsTabCategoryEspDNames and library.pointers.VisualsTabCategoryEspDNames.value then
		table.insert(TDNames, AddTagToBox(Box, "up", plrs[Box.Name].DisplayName, library.pointers.VisualsTabCategoryEspDNamesC.value, library.pointers.VisualsTabCategoryEspDNamesFont and Enum.Font[library.pointers.VisualsTabCategoryEspDNamesFont.value] or Enum.Font.Code, library.pointers.VisualsTabCategoryEspDNamesS.value))
	end
end
...
OnTagsRemove = function(Reset)
	...
	if Reset then
		if library.pointers.VisualsTabCategoryEspNames and library.pointers.VisualsTabCategoryEspNames.value then
			for _, v in ipairs(BoxesStoragePath:GetChildren()) do
				table.insert(TNames, AddTagToBox(v, "up", v.Name, library.pointers.VisualsTabCategoryEspNamesC.value, library.pointers.VisualsTabCategoryEspNamesFont and Enum.Font[library.pointers.VisualsTabCategoryEspNamesFont.value] or Enum.Font.Code, library.pointers.VisualsTabCategoryEspNamesS.value))
			end
		end
		if library.pointers.VisualsTabCategoryEspDNames and library.pointers.VisualsTabCategoryEspDNames.value then
			for _, v in ipairs(BoxesStoragePath:GetChildren()) do
...
VisualsTabCategoryEsp:AddToggle("Names", false, "VisualsTabCategoryEspNames", function(val)
	if val then
		RemoveTags(true)
	else
		RemoveTags(true)
...
VisualsTabCategoryEsp:AddColorPicker("Color", Color3.new(1, 1, 1), "VisualsTabCategoryEspNamesC", function(val)
	if #TNames > 0 then
...
VisualsTabCategoryEsp:AddDropdown("Font", Fonts, "Code", "VisualsTabCategoryEspNamesFont", function(val)
	RemoveTags(true)
end)

VisualsTabCategoryEsp:AddSlider("Size", {0, 50, 15, 0.01, ""}, "VisualsTabCategoryEspNamesS", function()
	RemoveTags(true)
end)

VisualsTabCategoryEsp:AddToggle("Display Names", false, "VisualsTabCategoryEspDNames", function(val)
	if val then
		RemoveTags(true)
	else
		RemoveTags(true)
...
VisualsTabCategoryEsp:AddColorPicker("Color", Color3.new(1, 1, 1), "VisualsTabCategoryEspDNamesC", function(val)
	if #TDNames > 0 then
...
VisualsTabCategoryEsp:AddDropdown("Font", Fonts, "Code", "VisualsTabCategoryEspDNamesFont", function(val)
	RemoveTags(true)
end)

VisualsTabCategoryEsp:AddSlider("Size", {0, 50, 15, 0.01, ""}, "VisualsTabCategoryEspDNamesS", function()
	RemoveTags(true)
end)
