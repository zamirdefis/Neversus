...
VisualsTabCategoryCamera:AddSlider("Camera Min Zoom Distance", {0.1, 10000, plr.CameraMinZoomDistance, 0.01, ""}, "VisualsTabCategoryCameraCameraMaxZoomDistance", function(val)
	plr.CameraMinZoomDistance = val
end)

VisualsTabCategoryCamera:AddSlider("Camera Max Zoom Distance", {0.1, 10000, plr.CameraMaxZoomDistance, 0.01, ""}, "VisualsTabCategoryCameraCameraMaxZoomDistance", function(val)
