...
local colorTaker = hgui:WaitForChild("colorTaker")
...
local ctCloseButt = colorTaker:WaitForChild("close")
local ctRed = colorTaker:WaitForChild("red")
local ctGreen = colorTaker:WaitForChild("green")
local ctBlue =  colorTaker:WaitForChild("blue")
local ctTransp = colorTaker:WaitForChild("transparency")
local ctColorFromT = colorTaker:WaitForChild("colorFromT")
