...
OnBoxAdd = function(Box)
	...
	if library.pointers.VisualsTabCategoryEspArmor and library.pointers.VisualsTabCategoryEspArmor.value then
		if plrs[Box.Name] then
			local Hum = plrs[Box.Name].Character:WaitForChild("Humanoid")
			local Tag = AddTagToBox(Box, "right", "", library.pointers.VisualsTabCategoryEspArmorC.value, Enum.Font[library.pointers.VisualsTabCategoryEspArmorFont.value], library.pointers.VisualsTabCategoryEspArmorS.value, library.pointers.VisualsTabCategoryEspArmorTT.value, library.pointers.VisualsTabCategoryEspArmorTST.value, library.pointers.VisualsTabCategoryEspArmorSC.value)
			table.insert(TArmor, Tag)
			local function ShowTag()
				Tag:Destory()
				Tag = AddTagToBox(Box, "right", "HK", library.pointers.VisualsTabCategoryEspArmorC.value, Enum.Font[library.pointers.VisualsTabCategoryEspArmorFont.value], library.pointers.VisualsTabCategoryEspArmorS.value, library.pointers.VisualsTabCategoryEspArmorTT.value, library.pointers.VisualsTabCategoryEspArmorTST.value, library.pointers.VisualsTabCategoryEspArmorSC.value)
	...
	if Reset then
		...
		if library.pointers.VisualsTabCategoryEspArmor and library.pointers.VisualsTabCategoryEspArmor.value then
			for _, v in ipairs(BoxesStoragePath:GetChildren()) do
				if plrs[v.Name] then
					local Hum = plrs[v.Name].Character:WaitForChild("Humanoid")
					local Tag = AddTagToBox(v, "right", "", library.pointers.VisualsTabCategoryEspArmorC.value, Enum.Font[library.pointers.VisualsTabCategoryEspArmorFont.value], library.pointers.VisualsTabCategoryEspArmorS.value, library.pointers.VisualsTabCategoryEspArmorTT.value, library.pointers.VisualsTabCategoryEspArmorTST.value, library.pointers.VisualsTabCategoryEspArmorSC.value)
					table.insert(TArmor, Tag)
					local function ShowTag()
						Tag:Destory()
						Tag = AddTagToBox(v, "right", "HK", library.pointers.VisualsTabCategoryEspArmorC.value, Enum.Font[library.pointers.VisualsTabCategoryEspArmorFont.value], library.pointers.VisualsTabCategoryEspArmorS.value, library.pointers.VisualsTabCategoryEspArmorTT.value, library.pointers.VisualsTabCategoryEspArmorTST.value, library.pointers.VisualsTabCategoryEspArmorSC.value)
						if library.pointers.VisualsTabCategoryEspArmorCCWAIB.value then
							local function ChengeColor()
								if Hum.Health <= 50 then
									Tag.TextColor3 = library.pointers.VisualsTabCategoryEspACCWAIBColor.value
